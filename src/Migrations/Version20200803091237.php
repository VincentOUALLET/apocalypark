 ...
 */
final class Version20200803091237 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD user_id INT NOT NULL, DROP customer_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD customer_id INT DEFAULT NULL, DROP user_id');
