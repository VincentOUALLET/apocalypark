...
class __TwigTemplate_9e60f5a06410207c5de4b7805d782fbea14ce1402c8b0eeef8b816ebb965aa82 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>";
            // line 30
            echo ((twig_get_attribute($this->env, $this->source, $context["user"], "rgpd", [], "any", false, false, false, 30)) ? ("Yes") : ("No"));
            echo "</td>
                <td>";
            // line 31
            echo ((twig_get_attribute($this->env, $this->source, $context["user"], "isVerified", [], "any", false, false, false, 31)) ? ("Yes") : ("No"));
            echo "</td>
                <td>";
            // line 32
...
{% endblock %}
", "user/index.html.twig", "/home/voualla/Documents/Symfony/apocalypark/apocalypark/templates/user/index.html.twig");
    }
}
